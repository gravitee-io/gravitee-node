...
public class RefreshableX509KeyManagerDelegatorTest {
    ...
    public void should_choose_default_alias_when_no_sni() {
        ...
        cut.setDefaultAlias("localhost");
        cut.refresh(keyStore, PASSWORD.toCharArray());
    ...
    @Test
    public void should_fail_refresh_on_wrong_default_alias() {
        final KeyStore keyStore = loadAllInOne();
        cut = new RefreshableX509KeyManagerDelegator("http", false);
