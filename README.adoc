...
The Gravitee Node ArchUnit module provides a set of reusable architecture rules to enforce consistency across the codebase using link:https://www.archunit.org/[ArchUnit].
