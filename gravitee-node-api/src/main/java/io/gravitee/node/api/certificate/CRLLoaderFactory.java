...
/**
 * Factory responsible for creating {@link CRLLoader} instances based on provided options.
 * Implementations should check if they can handle specific CRL loader options before creating loaders.
 *
