...
public class KubernetesSecretKeyStoreLoaderTest {
  ...
  public void shouldLoadTlsSecret() throws IOException, KeyStoreException {
    final KeyStoreLoaderOptions options = KeyStoreLoaderOptions
      ...
      .withKubernetesLocations(
        Collections.singletonList("/gio/secrets/my-tls-secret")
      )
      .withWatch(false)
      .build();
    ...
    metadata.setSelfLink("/namespaces/gio/secrets/my-tls-secret");
  ...
  public void shouldLoadOpaqueSecret() throws IOException, KeyStoreException {
    final KeyStoreLoaderOptions options = KeyStoreLoaderOptions
      ...
      .withKubernetesLocations(
        Collections.singletonList("/gio/secrets/my-tls-secret/keystore")
      )
  ...
  public void shouldNotLoadOpaqueSecretPEM() {
    final KeyStoreLoaderOptions options = KeyStoreLoaderOptions
      ...
      .withKeyStoreType(KeyStoreLoader.CERTIFICATE_FORMAT_PEM)
      .withKubernetesLocations(
        Collections.singletonList("/gio/secrets/my-tls-secret/pem")
      )
      .withKeyStorePassword("secret")
      .withWatch(false)
      .build();
  ...
  public void shouldNotLoadWithInvalidSecretType() {
    final KeyStoreLoaderOptions options = KeyStoreLoaderOptions
      ...
      .withKeyStoreType(KeyStoreLoader.CERTIFICATE_FORMAT_PKCS12)
      .withKubernetesLocations(
        Collections.singletonList("/gio/secrets/my-tls-secret/invalid-keystore")
      )
      .withKeyStorePassword("secret")
      .withWatch(false)
      .build();
  ...
  public void shouldWatchSecret()
    ...
    modifiedMetadata.setSelfLink("/namespaces/gio/secrets/my-tls-secret");
    ...
    assertTrue(
      KeyStoreUtils
        .getCommonNamesByAlias(keyStoreBundle.getKeyStore())
        .containsKey("localhost2")
    );
  }
