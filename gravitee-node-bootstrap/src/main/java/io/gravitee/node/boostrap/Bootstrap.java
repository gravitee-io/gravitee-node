 ...
 */
package io.gravitee.node.boostrap;
...
public class Bootstrap {
    ...
    private static final String CONTAINER_CLASS = "io.gravitee.node.container.Container";
    ...
    private void checkInstallRoot(File graviteeHomeDir) {
        ...
        File [] files = graviteeLibDir.listFiles(pathname ->
                pathname.getName().startsWith("gravitee-node-bootstrap"));
