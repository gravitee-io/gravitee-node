...
public abstract class AbstractNode
  ...
  protected void doStop() throws Exception {
    ...
    ListReverser<Class<? extends LifecycleComponent>> components = new ListReverser(
      this.components()
    );
    ...
    while (var2.hasNext()) {
      ...
      try {
        LifecycleComponent lifecyclecomponent = (LifecycleComponent) this.applicationContext.getBean(
            componentClass
          );
