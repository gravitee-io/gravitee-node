...
public abstract class AbstractContainer extends AbstractService<Container> implements Container {
    ...
    private final static String GRAVITEE_HOME_PROPERTY = "gravitee.home";
    private final static String GRAVITEE_CONFIGURATION_PROPERTY = "gravitee.conf";
    ...
    protected void initializeEnvironment() {
        ...
        if (graviteeConfiguration == null || graviteeConfiguration.isEmpty()) {
            ...
            System.setProperty(GRAVITEE_CONFIGURATION_PROPERTY,
