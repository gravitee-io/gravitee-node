 ...
 *     <li>Formats each entry using the configured format pattern (e.g., {@code %s="%s"})</li>
 *     <li>Substitutes the configured null-value for missing MDC entries</li>
...
public class MdcListConverter extends ClassicConverter {
     ...
     * with missing MDC values replaced by the configured null-value.
     *
    ...
    public String convert(ILoggingEvent event) {
        ...
        for (String key : includeKeys) {
            ...
            joiner.add(String.format(format, key, value != null ? value : nullValue));
        }
