 ...
 */
package io.gravitee.node.plugin.cluster.standalone.spring;

import io.gravitee.node.api.cache.CacheManager;
import io.gravitee.node.api.cluster.ClusterManager;
import io.gravitee.node.api.message.MessageProducer;
import io.gravitee.node.plugin.cluster.standalone.StandaloneCacheManager;
import io.gravitee.node.plugin.cluster.standalone.StandaloneClusterManager;
import io.gravitee.node.plugin.cluster.standalone.StandaloneMessageProducer;
