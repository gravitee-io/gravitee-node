...
import io.gravitee.node.plugin.cluster.hazelcast.HazelcastCacheManager;
import io.gravitee.node.plugin.cluster.hazelcast.HazelcastClusterManager;
import io.gravitee.node.plugin.cluster.hazelcast.HazelcastMessageProducer;
...
public class HazelcastClusterConfiguration {
    ...
    public HazelcastInstance distributedHazelcastInstance() throws Exception {
        ...
        config.setClassLoader(HazelcastClusterConfiguration.class.getClassLoader());
