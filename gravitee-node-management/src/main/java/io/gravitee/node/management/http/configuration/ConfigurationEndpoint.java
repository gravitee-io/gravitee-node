...
public class ConfigurationEndpoint implements ManagementEndpoint {
  ...
  private static final Set<String> PROPERTY_PREFIXES = new HashSet<>(
    Arrays.asList("gravitee.", "gravitee_", "GRAVITEE.", "GRAVITEE_")
  );

  private static final String ENDPOINT_PATH = "/configuration";

  private static final String PROPERTY_SOURCE_CONFIGURATION =
