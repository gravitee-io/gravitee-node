...
public class HealthcheckManagementEndpointTest {

    @Mock
    private ProbeStatusRegistry probeStatusRegistry;
    ...
    private HealthcheckManagementEndpoint healthcheckManagementEndpoint;
    ...
    @Before
    public void setUp() {
        healthcheckManagementEndpoint = new HealthcheckManagementEndpoint();
        healthcheckManagementEndpoint.setRegistry(probeStatusRegistry);
    ...
    public void shouldNotFilterAllHealthy() throws Exception {
        ...
        healthcheckManagementEndpoint.handle(routingContext);
    ...
    private Result mockResult(boolean isHealthy) {
        ...
        when(result.isHealthy()).thenReturn(isHealthy);
        return result;
    }
