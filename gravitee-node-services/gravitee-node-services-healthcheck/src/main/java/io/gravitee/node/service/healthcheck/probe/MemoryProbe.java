 ...
 */
package io.gravitee.node.service.healthcheck.probe;

import io.gravitee.node.api.healthcheck.Probe;
import io.gravitee.node.api.healthcheck.Result;
import io.gravitee.node.service.healthcheck.probe.internal.JvmProbe;
...
public class MemoryProbe implements Probe {
    ...
    public MemoryProbe(@Value("${services.health.threshold.memory:80}") int threshold) {
