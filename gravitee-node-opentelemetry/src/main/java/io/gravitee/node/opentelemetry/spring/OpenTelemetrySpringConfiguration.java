...
public class OpenTelemetrySpringConfiguration {
    ...
    @Bean
    public ExporterFactory exporterFactory(final OpenTelemetryConfiguration openTelemetryConfiguration, @Lazy final Vertx vertx) {
    ...
    public OpenTelemetryFactory openTelemetryFactory(
        ...
        return new OpenTelemetryFactory(openTelemetryConfiguration, exporterFactory, instrumenterTracerFactories);
    }
