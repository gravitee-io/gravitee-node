package io.gravitee.node.heartbeat.eventbus;
 ...
 */
public class HeartbeatCodec implements MessageCodec<Event, Event> {

    private static final Logger LOGGER = LoggerFactory.getLogger(HeartbeatCodec.class);
    public static final String CODEC_NAME = "gio:bus:codec:heartbeat";
