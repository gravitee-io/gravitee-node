...
import io.gravitee.node.cluster.standalone.StandaloneCacheManager;
...
public class StandaloneClusterConfiguration {
  ...
  public static class StandaloneModeEnabled implements Condition {
    ...
    public boolean matches(
      ...
      String clusterEnabled = conditionContext
        .getEnvironment()
        .getProperty("gravitee.cluster.enabled");
      return clusterEnabled == null || "false".equals(clusterEnabled);
    }
  }
}
