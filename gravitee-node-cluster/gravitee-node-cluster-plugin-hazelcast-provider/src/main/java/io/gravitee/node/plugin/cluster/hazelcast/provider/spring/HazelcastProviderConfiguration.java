...
/**
 * Owns the embedded Hazelcast instance and exposes it via {@link DistributedMapProvider}. Config
 * paths remain under {@code cluster.hazelcast.*} for backwards compatibility with deployments
 * that already ship {@code hazelcast-cluster.xml}.
 */
@Configuration
