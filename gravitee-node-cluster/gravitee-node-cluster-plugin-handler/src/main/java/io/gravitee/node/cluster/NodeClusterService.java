...
import io.gravitee.node.cluster.endpoint.ClusterHealthEndpoint;
import io.gravitee.node.cluster.healthcheck.ClusterProbe;
...
public class NodeClusterService extends AbstractService<NodeClusterService> {
    ...
    public void doStart() throws Exception {
        ...
        try {
            ...
            managementEndpointManager.register(new ClusterHealthEndpoint(clusterManager));
