...
public class VertxHttpClientOptions implements Serializable {
    ...
    public static final long DEFAULT_MAX_CONNECTION_LIFETIME = 0;
    ...
    /**
     * Maximum lifetime of a pooled connection, in milliseconds, after which it is recycled.
     * Default is {@value DEFAULT_MAX_CONNECTION_LIFETIME} which means no maximum lifetime.
     */
    @Builder.Default
