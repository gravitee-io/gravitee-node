...
import io.gravitee.node.vertx.configuration.VertxHttpServerConfiguration;
 ...
 */
public class VertxReactivexHttpServerFactory implements FactoryBean<HttpServer> {
