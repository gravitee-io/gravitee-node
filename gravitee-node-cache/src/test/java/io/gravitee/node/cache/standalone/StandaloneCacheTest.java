...
public class StandaloneCacheTest {
  ...
  @Test
  public void shouldUseGlobalTimeToLiveWhenSpecificTTLIs0()
    ...
    // Specific time to live is 0 == infinite keeping
  ...
  public void shouldPutMultipleValues() {
    ...
    cache.putAll(
      Map.of(TEST_KEY, TEST_VALUE, ANOTHER_TEST_KEY, ANOTHER_TEST_VALUE)
    );
    assertEquals(TEST_VALUE, cache.get(TEST_KEY));
    assertEquals(ANOTHER_TEST_VALUE, cache.get(ANOTHER_TEST_KEY));
  }
